...
NA VERCEL TEMOS QUE REALIZAR UMA CONFIGURAÇÃO POIS ESTAMOS USANDO O GRUNT, NA VERCEL ELE VAI TER QUE EXECUTAR O COMANDO build, DO ARQUIVO gruntfile.js, ELE VAI SER ACESSIVEL ATRAVEZ DO packaeg.json ATRAVES DO "build": "grunt build",

CLICAMOS EM IMPORT NA VERCEL, DENTRO DA OPÇÃO DE BUILD AND OUTPUT SETTINGS, TEMOS QUE ABRIR E COLOCAR EM Build Command
npm run build

 EM Output Directory QUE SÃO ONDE OS ARQUIVOS PUBLICOS DO NOSSO PROJETO ESTÃO:
 dist
