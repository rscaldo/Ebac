...
VAMOS CRIAR UMA TAREFA QUE SERA RESPONSAVEL DE COMPRIMIR OS ARQUIVOS DE JS, PARA ISSO TEMOS QUE INSTALAR UM PLUGIN
npm install --save-dev gulp-uglify

TEMOS QUE IMPORTAR COM:
const uglify = requere('gulp-uglify')

APOS INSTALAÇÃO VAMOS CRIAR MAIS UMA TAREFA
...
APÓS ESSES COMANDOS VAMOS EXPORTAR ESSAS TAREFAS
exports.javascript = comprimeJavaScript;

TEMOS QUE CRIAR AS PASTAS IGUAL AO ESPECIFICADO NA TAREFA E VAMOS JOGAR NA PASTA source/scripts OS ARQUIVOS aritmetica.js e sum.js NÃO VAMOS ATUALIZAR AS IMPORTAÇÕES(AVISO DO VSCODE)

EXECULTAR A FUNÇÃO QUE ACABAMOS DE EXPORTAR:
npm run gulp javascript

DENTRO DA PASTA build/scripts FORAM CRIADOS OS SEGUINTES ARQUIVOS aritmetica.js e sum.js MAS COM VERSÕES MIMIFICADAS

PODEMOS UTILIZAR UM PLUGIN PARA DIFICULTAR A LEITURA DO NOSSO CÓDIGO JS, ISSO SERVE PARA SEGURANÇA
npm install --save-dev gulp-obfuscate

TEMOS QUE IMPORTAR O PLUGIN
...
COMPRIMIR IMAGENS ATRAVEZ DO GULP
INSTALAR O PLUGIN
...
APOS COLOCAR AS IMAGENS DENTRO DA PASTA PODEMOS EXECULTAR A TAREFA
$ npm install --save-dev gulp-imagemin@7.1.0
INSTALAR VERSÃO MAIS ANTIGA PARA FUNCIONAR
npm run gulp images
 */
