    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log("inicio3");
          _context.next = 3;
          return funcaoMuitoPesadaPromise.then(function (resultado) {
            return console.log(resultado);
          }).catch(function (erro) {
            return console.log(erro);
          });
...
function execucaoPrincipal2() {
  return _execucaoPrincipal2.apply(this, arguments);
}
function _execucaoPrincipal2() {
  _execucaoPrincipal2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var resultado;
